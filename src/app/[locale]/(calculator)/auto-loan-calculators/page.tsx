...
export default function AutoLoanCalculator() {
    ...
    const [loanTerm, setLoanTerm] = useState<number>(5); // Auto loans typically have shorter terms (e.g., 5 years)
    ...
    return (
        <Card className="w-full h-screen flex flex-col justify-center items-center py-24 md:py-24 lg:py-24">
            <CardHeader>
                <CardTitle className="flex justify-center">{t('autoLoanCalculatorTitle')}</CardTitle>
                <CardDescription className="flex justify-center">{t('autoLoanCalculatorDescription')}</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="grid gap-6 sm:grid-cols-2">
                    <div className="space-y-2">
                        <Label htmlFor="loanAmount">{t('autoLoanAmountLabel')}</Label>
                        <Input
                            id="loanAmount"
                            type="text"
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={handleInputChange(setLoanTerm, 7)} // Auto loan terms are typically up to 7 years
                        />
                        <Slider
                            min={1}
                            max={7}
                    ...
                    <div className="space-y-2 sm:col-span-2">
                        <h3 className="text-lg font-semibold">{t('autoLoanSummary')}</h3>
